...
for (ii in 1:nstates) {
  # Extract 2013 data 
  treat2013 <- filter(treated, year == 2013 & population == states[ii])$value
...
treated <- arrange(treated, population, year)
...
if (saveCascade) {
  ...
  saveString <- file.path(outputFolder, paste("HIVcascadeEstimates-",toString(analysisYear)))
