...
s100data <- read.csv(file.path(dataFolder, "s100_treatment_costs.csv"), as.is = 1)
prospectionData <- read.csv(file.path(dataFolder, "pharmdash_HIVpatients2014.csv"), as.is = 1)
...
s100data$relative <- s100data$totalspend/filter(s100data, year == 2012)$totalspend

lms100 <- lm(relative ~ year, data = filter(s100data, year < 2013)) 
predict(lms100,data.frame(year = 2003:2013))
