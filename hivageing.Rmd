...
unknownDeathsMales <- estimateDeathsMale - colSums(ageDeathMale)
...
absDeathRatesMales <- filter(absDeathRates, sex == "male")
...
for (ii in 2:nyears) {
  ...
  if (yearsVec[ii - 1] <= 2000) {
    ...
    absDeaths <- filter(absDeathRatesAll, year == yearsVec[ii - 1])$deathrate
  }
