...
# NSW
hivAdjustments$pstay_aus <- rep((1 - 0.0072), length(allYears)) / 
  hivBaseRates$propstay
hivAdjustments$pstay_aus_lower <- rep((1 - 2 * 0.0072), 
  length(allYears)) / 
  hivBaseRates$propstay_lower
hivAdjustments$pstay_aus_upper <- rep(1, length(allYears)) / 
  hivBaseRates$propstay_upper

hivAdjustments$pstay_os <- rep((1 - 0.1008), length(allYears)) / 
  hivBaseRates$propstay
hivAdjustments$pstay_os_lower <- rep((1 - 2 * 0.1008), 
  length(allYears)) / 
  hivBaseRates$propstay_lower
