...
# TODO: TEMPORARY FILE BEING USED AS MISSING DATA FOR NSW AND WA 
# 27 June 2022
absInterstate <- read.csv(file.path(mainDataFolder, 
  paste0("ABS_interstate_clean-", analysisYear, "-temp.csv")), 
  as.is = 1) %>%
...
# from NSW Health cumulatively over 2013-2020. Data for 2013-2020 in the 
# local file 
# ~\Australian Care Cascades - Documents\data\6m_followUp_NSW_27Oct2021.xlsx.
# The variables below store the cumulative emigration proportion for 
# Australian born diagnosed and overseas born to end 2020. 
ausBornEmigrate <- 0.00702
osBornEmigrate <- 0.0857
