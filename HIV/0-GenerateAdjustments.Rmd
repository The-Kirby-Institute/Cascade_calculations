...
ageList <- c("a0_4", "a4_9","a10_14", "a15_19", "a20_24", "a25_29", 
...
for (ii in 2:nyears) {
  ...
  for (jj in 1:nages) {
    ...
    agePldhiv[jj, ii] <- agePldhiv[jj, ii - 1] + ageDiag[jj, ii] - 
      (1-hivBaseRates$propstay[ii-1]) * ageDiag[jj, ii] - 
    ...
    agePldhivMale[jj, ii] <- agePldhivMale[jj, ii - 1] + 
      ageDiagMale[jj, ii] - 
      (1-hivBaseRates$propstay[ii-1]) * ageDiagMale[jj, ii] - 
    ...
    agePldhivFemale[jj, ii] <- agePldhivFemale[jj, ii - 1] + 
      ageDiagFemale[jj, ii] - 
      (1-hivBaseRates$propstay[ii-1]) * ageDiagFemale[jj, ii] - 
