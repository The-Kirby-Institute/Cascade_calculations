...
ausBornEmigrate <- 
  c(
    ...
    rep(ausBornEmigrateCOVID, length(2022:analysisYear))
  ) 
...
osBornEmigrate <- 
  c(
    ...
    rep(osBornEmigrateCOVID, length(2022:analysisYear))
  ) 
...
# Load gender deathrate ratios - NNED TO UPDATE THE ESTIMATES IN THIS FILE EACH
# YEAR
