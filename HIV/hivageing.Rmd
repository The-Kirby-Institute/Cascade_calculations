...
# TEMP: merge bins into <30, 30-49, 50+
pldhivTidyASR <- pldhivTidy %>% spread(age, value) %>%
  mutate(`<30` = `<15` + `15-19` + `20-24` + `25-29`,
         `30-49` = `30-34` + `35-39` + `40-44` + `45-49`,
         `50+` = `50-54` + `55-59` + `60-64` + `65-69` + `70+`) %>%
  select(year, `<30`, `30-49`, `50+`) %>%
...
if (calculateGender) {
  ...
  pldhivTidyMaleASR <- pldhivTidyMale %>% spread(age, value) %>%
    mutate(`<30` = `<15` + `15-19` + `20-24` + `25-29`,
           `30-49` = `30-34` + `35-39` + `40-44` + `45-49`,
           `50+` = `50-54` + `55-59` + `60-64` + `65-69` + `70+`) %>%
    select(year, `<30`, `30-49`, `50+`) %>%
  ...
  pldhivTidyFemaleASR <- pldhivTidyFemale %>% spread(age, value) %>%
    mutate(`<30` = `<15` + `15-19` + `20-24` + `25-29`,
           `30-49` = `30-34` + `35-39` + `40-44` + `45-49`,
           `50+` = `50-54` + `55-59` + `60-64` + `65-69` + `70+`) %>%
    select(year, `<30`, `30-49`, `50+`) %>%
...
if (calculateGender) {
  ...
  pldhivTidyMaleASR <- pldhivTidyMaleASR %>%
    filter(year >= startYear) %>%
    rename(number = value)
  ...
  pldhivTidyFemaleASR <- pldhivTidyFemaleASR %>%
    filter(year >= startYear) %>%
    rename(number = value)
}
...
barPlotAllASR <- ggplot(data = pldhivTidyASR, aes(x = year, y = number, 
  fill = age)) + geom_bar(stat = "identity") + 
  xlab("Year") + ylab("Number of people") +
  scale_fill_manual(values = asrcols[c(1,3,5)], name = "Age") + 
  scale_x_continuous(breaks = xValues) + 
  plotOpts + theme(legend.position = "",
                   legend.text = element_text(size = 8))
...
propPlotAllASR <- ggplot(data = pldhivTidyASR, aes(x = year, y = number, 
  fill = age)) + geom_bar(stat="identity", position = "fill") + 
  xlab("Year") + ylab("Proportion of people") +
  scale_fill_manual(values = asrcols[c(1,3,5)], name = "Age") + 
  scale_x_continuous(breaks = xValues) + 
...
barPlotMale <- ggplot(data = pldhivTidyMale, aes(x = year, y = number, 
  fill = age)) + geom_bar(stat = "identity") + 
  xlab("Year") + ylab("Number of people (males)") +
  scale_fill_manual(values = mainColours, name = "Age",
                    guide = guide_legend(reverse=TRUE)) + 
  scale_x_continuous(breaks = xValues) + 
  plotOpts + theme(legend.position = "",
...
barPlotMaleASR <- ggplot(data = pldhivTidyMaleASR, 
                         aes(x = year, y = number,
  fill = age)) + geom_bar(stat = "identity") + 
  xlab("Year") + ylab("Number of people (males)") +
  scale_fill_manual(values = asrcols[c(1,3,5)], name = "Age") + 
...
propPlotMale <- ggplot(data = pldhivTidyMale, aes(x = year, y = number, 
  fill = age)) + geom_bar(stat="identity", position = "fill") + 
  xlab("Year") + ylab("Proportion of people (males)") +
  scale_fill_manual(values = mainColours, name = "Age") + 
  scale_x_continuous(breaks = xValues) + 
  plotOpts + theme(legend.position = "right",
                   legend.text = element_text(size = 8))

propPlotMaleASR <- ggplot(data = pldhivTidyMaleASR, 
                          aes(x = year, y = number, 
  fill = age)) + geom_bar(stat="identity", position = "fill") + 
  xlab("Year") + ylab("Proportion of people (males)") +
  scale_fill_manual(values = asrcols[c(1,3,5)], name = "Age") + 
...
barPlotFemale <- ggplot(data = pldhivTidyFemale, 
                        aes(x = year, y = number, 
                            fill = age)) + geom_bar(stat = "identity") + 
  xlab("Year") + ylab("Number of people (females)") +
  scale_fill_manual(values = mainColours, name = "Age",
                    guide = guide_legend(reverse=TRUE)) + 
  scale_x_continuous(breaks = xValues) + 
  plotOpts + theme(legend.position = "",
...
barPlotFemaleASR <- ggplot(data = pldhivTidyFemaleASR, 
                        aes(x = year, y = number, 
                            fill = age)) + geom_bar(stat = "identity") + 
  xlab("Year") + ylab("Number of people (females)") +
  scale_fill_manual(values = asrcols[c(1,3,5)], name = "Age") + 
...
propPlotFemale <- ggplot(data = pldhivTidyFemale, 
                         aes(x = year, y = number, 
                             fill = age)) + geom_bar(stat="identity", position = "fill") + 
  xlab("Year") + ylab("Proportion of people (females)") +
  scale_fill_manual(values = mainColours, name = "Age",
                    guide = guide_legend(reverse=TRUE)) + 
  scale_x_continuous(breaks = xValues) + 
  plotOpts + theme(legend.position = "right",
...
propPlotFemaleASR <- ggplot(data = pldhivTidyFemaleASR, 
                         aes(x = year, y = number, 
                             fill = age)) + geom_bar(stat="identity", position = "fill") + 
  xlab("Year") + ylab("Proportion of people (females)") +
  scale_fill_manual(values = asrcols[c(1,3,5)], name = "Age") + 
