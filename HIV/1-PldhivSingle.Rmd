...
living with diagnosed HIV in Australia for a single region or jurisdiction.
This is the core script for producing the estimates of the Australian HIV
diagnosis and care cascade. 

This script is part of a project containing version 4.0 of the HIV cascade
calculation scripts. 
...
LoadLibray(tidyverse) # TODO: Make code more tidyverse like
...
```{r Script parameters}
# Chunk to enter all the script parameters we will use for a single 
# region
analysisYear <- 2016
saveResults <- FALSE
...
# calculations are done for all age groups specified as a0_4, a5_9, 
...
targetState <- "wa" # all, nsw, sa, nt, qld, vic, wa, act, tas
                    # (can handle combinations but this produces
                    # inaccurate estimates)
targetLocalRegion <- "all" # TODO: (can handle combinations but this 
...
targetGlobalRegion <- "all" # South-East Asia, Sub-Saharan Africa, 
                            ...
                            # (can handle combinations but this 
                            # produces inaccurate estimates)
