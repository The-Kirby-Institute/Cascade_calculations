...
prospectionYears <- 2013:analysisYear #c(2013, 2014)
...
if (analysisYear == 2014) {
  ...
  # For 2017 data the fit is sensitive to the inflection point. The best 
  # fit looks to occur at 2013. 
  inflectionYear <- 2013
} else {
  inflectionYear <- 2015
  warning("inflectionYear needs to be tested for Fit")
}
