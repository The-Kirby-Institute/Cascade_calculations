...
(ART) in Australia over 2000-2014. It estimates the number taking ART 
...
# indexFit <- nrow(filter(artEstimates, year %in% c(2010:2012)))

# Replace 2010:2012 values with fitted values as these were projected 
# anyway and are not direct estimates
artEstimates$alladjust <- artEstimates$all
artEstimates[artEstimates$year %in% c(2010:2012), ]$alladjust <- 
  artEstimates[artEstimates$year %in% c(2010:2012), ]$fitlog 
