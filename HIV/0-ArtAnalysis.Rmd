...
if (analysisYear == 2014) {
  ...
  # For 2017 data a four paramater fit can be done but confident 
  # intervals are problematic and messes up code below
  # Do a 4 parameter fit first and then fix inflectionYear value and
  # refit
