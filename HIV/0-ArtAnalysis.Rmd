...
3. The Pharmaceutical Benefits Scheme (PBS) 100% longitudinal sample 
provided to the Kirby Institute directly from the department of Health.
This data is only available from 2014. This data is considered to be the
most reliable and direct estimate. Though there is uncertainty given the 
difficulties in cleaning the data to remove ART drug scripts used for 
other purposes such as Hep B, HIV PrEP and PEP. 
...
if (analysisYear < 2020) {
  ...
  pbsFile <- file.path(dataFolder,
    paste0("pbs_art_clean-", analysisYear,
      ".csv"))
}
...
pbsYears <- pbsYears[pbsYears <= dataYear]
