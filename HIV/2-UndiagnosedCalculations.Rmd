...
analysisYear <- 2024
saveResults <- TRUE 
projectFolder <-  "ASR_2025" # "ASR_2025"
                             # "HIV_Cascade_Paper" 
                             # 
...
if (saveResults) {
  ...
  # Write to csv
  write_excel_csv(plhivResults, paste0(saveStringPlhiv, ".csv")) 
  ...
  # Write to csv
  write_excel_csv(plhiv, paste0(saveStringUndiagnosed, ".csv"))
  ...
  if (getNewInfections) {
    ...
    # Write to csv
    write_excel_csv(newInfections, paste0(saveStringInfections, ".csv"))
  }
}
