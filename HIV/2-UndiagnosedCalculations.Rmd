...
analysisYear <- 2019
saveResults <- TRUE 
projectFolder <- "Undiagnosed_Metrics_Paper" # "ASR_2022"
# "HIV_Cascade_Paper"
cascadeFlag <- "MSM-Aus" # minus year
...
undiagnosedMethod <- ifelse(cascadeFlag == "Indigenous", "include", undiagnosedMethod)
getNewInfections <- TRUE 

# Use if ECDC bootstrapping hasn't been done
doUncertainty <- TRUE # Calculate uncertainty estimates
doUncertainty <- ifelse(cascadeFlag == "Indigenous", FALSE, doUncertainty)
