...
if (addTempRes) {
  ...
  # Use 2023 state data to allocate overall Medicare ineligible ART number to 
  # each state - the number for each state is availble in the file
  # ~/HIV/data/ART_medicare_ineligible-2023.csv

  statesProps <- c("act" = 29/2521, "nsw" = 976/2521, "nt" = 35/2521, 
    "qld" = 405/2521, "sa" = 117/2521, "tas" = 14/2521, "vic" = 700/2521, 
    "wa" = 245/2521)
    ...
    for (ii in 1:length(pops)) {
      ...
      if (pops[ii] == "female") {
        ...
        if (analysisYear < 2023) {
          ...
          # Year 2023 and a state 
          popProp <- unname(statesProps[pops[ii]])
          
          tempRes <- popProp * endTempRes
          tempResMin <- popProp * endTempResMin
          tempResMax <- popProp * endTempResMax
        }
      }
    ...
    for (pop in pops) {
      ...
      if (pop == "female") {
        ...
        if (analysisYear < 2023) {
          ...
          # Year 2023 and a state 
          popProp <- unname(statesProps[pop])
