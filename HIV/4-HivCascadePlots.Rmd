...
# specified cascade
projectName <- "Paper_2016" # "ASR_2017" 
...
if (projectName %in% c("ASR_2017", "ASR_2016")) {
...
if (asrCascades) {
  ...
  # Caption
  figs("plotBarGender", paste0("National HIV cascades for males and females in ", toString(resultsYear), "."))
