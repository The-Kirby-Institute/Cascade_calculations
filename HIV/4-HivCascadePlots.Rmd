...
if (pubPlots) {
  ...
  HIVdiagnosedPlot <- ggdraw() +
    draw_plot(plots[[2]], 0, 0.5, 0.5, 0.5) + #Number PLDHIV
    draw_plot(casesPlot, 0.5, 0.5, 0.5, 0.5) +
    draw_plot(plotDeaths, 0, 0, 0.5, 0.5) +
    draw_plot(plotDeathRate, 0.5, 0, 0.5, 0.5) +
  ...
  ggsave(file.path(figFolder, paste("HIVdiagnosed_indicators_", 
    toString(startYear), "-", toString(resultsYear), 
    saveFormat, sep = "")),
    plot = HIVdiagnosedPlot, width = 20, height = 16, units = "cm")
