...
minYear <- 14        # how long ago do we plot things (from 2004)
...
if (asrCascades && pubPlots) {
  ...
  propUnique <- tail(propUnique, 14) # 14 because of use of diff()
  # 2004-2016
...
if (asrCascades) {
  ...
  # "bornsea","othercob")
  pops <- c("ausnonatsi", "atsi", "ssa", "sea","othercob")
...
if (asrCascades) {
  ...
  # Rename second column
  finalTable[finalTable$population == "ausnonatsi",]$population <-
    "Australian born non-indigenous"
  finalTable[finalTable$population == "atsi",]$population <- 
