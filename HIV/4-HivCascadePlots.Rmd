...
# Script parameters ------------------------------------------------------
resultsYear <- 2018  # year of cascade we will plot
minYear <- 15        # how long ago do we plot things (from 2004)
startYear <- resultsYear - minYear + 1 

# Set up project - If ASR_2017 plot all populations otherwise just plot 
# specified cascade
projectName <- "ASR_2019" # "ASR_2018" "HIV_Cascade_Paper"
...
if (projectName %in% c("ASR_2019", "ASR_2018", "ASR_2017", "ASR_2016")) {
