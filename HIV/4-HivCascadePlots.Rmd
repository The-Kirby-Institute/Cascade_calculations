...
minYear <- 16        # how long ago do we plot things (from 2004)
startYear <- resultsYear - minYear + 1 

# Set up project - If ASR_2017 plot all populations otherwise just plot 
# specified cascade
projectName <- "HIV_Cascade_Paper" # "ASR_2020" "HIV_Cascade_Paper"
...
if (projectName %in% c("ASR_2020", "ASR_2019", "ASR_2018", "ASR_2017", 
  "ASR_2016")) {
...
if (pubPlots) {
  ...
  hivResults <- data_frame(yeardiagnosis = pldhivAll$year)
...
if (asrCascades && pubPlots) {
  ...
  propUnique <- tail(propUnique, 15) # 14 because of use of diff()
  # 2004-2018
...
if (asrCascades) {
  ...
  # "bornsea","othercob")
  pops <- c("ausnonindigenous", "indigenous", "ssa", "sea","othercob")
