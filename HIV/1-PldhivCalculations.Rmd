...
projectOutput <- "Undiagnosed_Metrics_Paper" # "Undiagnosed_Metrics_Paper" # "ASR_2022" for latest ASR
                            # "HIV_Cascade_Paper"
...
if (is.null(paramsFile)) {
  ...
  excludeOS <- rep(FALSE, numCascades) # Default FALSE but need to run with TRUE
