...
*Current projects*
- ASR_2016, ASR_2017, ASR_2018, ASR_2019, ASR_2020 (cascades for the Annual 
...
projectOutput <- "ASR_2020" # "." for main output folder 
                                 # "HIV_Cascade_Paper" for paper

# Project CSV file for specifying cascade parameters - NULL = manual 
# otherwise cascade parameters are entered via a file in projectOutput 
# which need to exist
...
if (is.null(paramsFile)) {
  ...
  excludeOS <- rep(TRUE, numCascades) # Default FALSE but need to run with
                                       # TRUE for ASR as
