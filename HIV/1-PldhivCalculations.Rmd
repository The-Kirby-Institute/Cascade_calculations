...
targetGender <- 'all' #male or female, Null both, add code for including/excluding NA's or missings 
targetAge <- 'all' #groups 0, 1, 2, 3, 4...
targetCob <- 'all' # all=including n/a, Thailand, Australia, etc.
targetExposure <- 'all' #msm, unknown, hetero, pwid, otherexp
targetAtsi <- 'all' # non_indigenous, indigenous
