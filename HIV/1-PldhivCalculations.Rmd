...
if (is.null(paramsFile)) {
  ...
  cascadeName <- "Test-region-2017" # (single)
  ...
  # tas (combination)
  targetLocalRegion <- rep("Daly - Tiwi - West Arnhem", numCascades) #tbd (combination)
...
for (ii in 1:numCascades) {
  ...
  if (useImputed[ii]) {
    ...
    numNotificationsOrig[ii] <- nrow(SubHivSet(hivData, "all", targetGender, 
