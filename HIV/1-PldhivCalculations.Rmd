...
- CALD_Cascades
- All-2016_Paper (national cascade for paper) uses main output directory
'.'
...
targetState <- c("nsw", "vic") # nsw, sa, nt, qld, vic, wa, act, tas
                               # (combination)
...
interState <- ifelse((targetState[1] != "all" && 
    length(targetState) != 1), TRUE, FALSE)
excludeAborig <- FALSE
