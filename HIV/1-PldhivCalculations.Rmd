...
projectOutput <- "ASR_2022" # "ASR_2022" for latest ASR
                            # "HIV_Cascade_Paper"
...
# which need to exist
paramsFile <- "ProjectParametersExtra.csv"
...
if (is.null(paramsFile)) {
  ...
  excludeOS <- rep(TRUE, numCascades) # Default FALSE but need to run with TRUE
