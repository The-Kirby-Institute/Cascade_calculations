...
if (projectPldhiv) { 
  ...
  # occur each year. MANUALLY CHANGE TO RUN ALTERNATE SCENARIOS.
  
  # Defaults - for diagnoses either assume a 5 year trend or the same 
  # number every year (status quo)
  #
  # Status quo diagnoses
  diagnosesSq <- ProjVec(adjustDiags$adjusted_included, nprojYears)
  ...
  diagnosesTrend <- c(adjustDiags$adjusted_included, trendDiags)
  
  # Use trend diagnoses as default
  diagnoses <- diagnosesTrend
  ...
  # TODO: Develop similiar process for pldhiv split by age 
}
```
