...
*Current projects*
- ASR_2016, ..., ASR_2023 (cascades for the Annual Surveillance Report(ASR))
...
projectOutput <- "HIV_Cascade_Paper" # "Undiagnosed_Metrics_Paper" # "ASR_2023" for latest ASR
                            # "HIV_Cascade_Paper"
...
if (is.null(paramsFile)) {
  ...
  # (combination). "Australia", "non-australia", "non-aus-nz", "non-aus-eng"
  ...
  # Parameter for adjusting migration rate to match data
  adjustment <- rep(1.46, numCascades) # All-2022 = 1.46; Default = 1 = no adjustment
  ...
  adjustment <- cascadeParameters$adjustment
