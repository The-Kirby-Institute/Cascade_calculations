...
*Current projects*
- ASR_2016, ..., ASR_2021 (cascades for the Annual Surveillance Report(ASR))
...
projectOutput <- "Victorian_Estimates_2020" # "." for main output folder
...
if (is.null(paramsFile)) {
  ...
  projectPldhiv <- rep(TRUE, numCascades) 
  
  # Manually set final year for projections and projection name
  projectYear <- 2030 #rep(analysisYear + 10, numCascades)  
