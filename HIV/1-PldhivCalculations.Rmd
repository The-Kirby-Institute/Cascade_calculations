...
if (calibration) {
  ...
  ecdcData <- FALSE 
  ecdcExcludeRun <- FALSE
  nImputedSets <- 1 # Try one first but need to do full set to validate calibration
...
if (calibration) {
  ...
  pldhiv <- pldhivCalculations[[1]]$pldhivAll  |> 
  ...
  print(adjustmentStart[1])
  print(adjustmentStop[1])
