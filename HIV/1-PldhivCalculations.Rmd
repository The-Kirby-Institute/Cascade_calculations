...
projectOutput <- "ASR_2019" # "." for main output folder 
...
if (is.null(paramsFile)) {
  ...
  # doAge below. 
  targetCob <- rep("Australia", numCascades) # all=including n/a, Thailand, etc.
  ...
  # as required. 
  excludeAborig <- rep(TRUE, numCascades) # FALSE be default to include 
                                           # indigenous
