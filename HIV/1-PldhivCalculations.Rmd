...
if (doUnique) {
  ...
  if (interState) {
    ...
    uniqueNotificationsNational <- GetUnique(hivSetUniqueAll[[1]], allYears, 
      yearUnique = yearUnique)
  }
} 
...
# migration rates
propDiagsAgeMale <- ProportionMale(hivSet, analysisYear, doAge)
propDiagsAgeMaleNational <- ProportionMale(hivSetAll, analysisYear, doAge)

# ProportionMale function
