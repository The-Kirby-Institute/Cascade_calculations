...
cascadeName <- paste0("SouthEastAsia-", toString(analysisYear)) 
targetGender <- 'all' # all, male, female
targetAge <- 'all' #groups 0, 1, 2, 3, 4...
targetCob <- 'all' # all=including n/a, Thailand, non-australia, etc.
...
targetGlobalRegion <- 'South-East Asia' #South-East Asia, Sub-Saharan Africa, Oceania, South American, Other cob, etc
