...
# Figure captions
captions[["cascadeFull"]] <- "HIV notifications in Australia and Australia's HIV cascade to the end of 2023. A) Annual notifications data. B) HIV cascade at end of 2023 including estimates for retained in care (note lower range of Diagnosed and Retained in care adjusted to equal lower range of number Receiving treatment). Horizontal lines show the UNAIDS 95-95-95 targets. C) Estimate numbers and percentages of people living with HIV in each step of the HIV cascade over 2004-2023.  "
