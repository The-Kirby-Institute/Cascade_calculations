...
initialParList <- list(
  "undiagnosed" = list(b= 2900, g = 0.2, d = 0.007, h = 3250),
  "noART" = list(b = 5800, g = 0.2, d = 0.133, h = 20000), 
  "unsuppressed" = list(b = 3000, g = 0.001, d = 0.05, h = 200),
  "diagnoses" = list(b= 900, g = 0.3, d = 0.01, h = 1100),
  "infections" = list(b= 900, g = 0.3, d = 0.01, h = 1100))
...
for (ii in fitIndicators) { 
  ...
  local({
    ...
    plotModel <- TRUE
    fitModel <- try( nls(tempData$value ~ FitModel(xseq, b, g, d, h),
