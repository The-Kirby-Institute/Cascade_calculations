...
trendData <- bind_rows(trendData, tibble(year = year,
  stage = "iproffset",
  # IPR is calculated using the plhiv number from the stary of each year
...
if (savePlots) {
  ggsave(file.path(figFolder,
    paste("HIVcascade_Indicators_Trends_",
      ...
      toString(resultsYear),
      saveFormat, sep = "")),
    plot = combinedIndicatorPlot, width = 18, height = 24, units = "cm")
}
...
cascadeTrendPlot <- ggdraw() + 
  ...
  draw_plot_label(c("A", "B", "C", "D"), 
    ...
    size = 12)
captions[["stepTrends"]] <- "Estimates and trends for each HIV cascade step over 2004-2020. Red lines and shading show the estimated values and range from the HIV cascade calculations. Black lines show the piecewise negative binomial model predictions. Vertical dashed lines show the location of detected change points. "
