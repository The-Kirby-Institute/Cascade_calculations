...
inputFile <- file.path(resultsFolder, paste0("All-", 
  toString(resultsYear), fileFlag), paste0("HIVcascadeEstimates-", 
...
# Add results to trendCascade
propTrends <- data_frame(stage = c("propdiagnosed", "proptreated",
  "propsuppressed"),
  coeff = c(coefflmdiags, coefflmart, coefflmsuppressed),
