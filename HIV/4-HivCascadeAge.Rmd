...
if (savePlots) {
  ...
  SaveFigure(figFolder, "All-2016_proportion", allPlots[[2]],
    format = saveFormat, width = width, height = height, units = units)
  SaveFigure(figFolder, "Male-2016_number", allPlots[[1]],
    format = saveFormat, width = width, height = height, units = units)
  SaveFigure(figFolder, "Male-2016_proportion", allPlots[[2]],
    format = saveFormat, width = width, height = height, units = units)
  SaveFigure(figFolder, "Female-2016_number", allPlots[[1]],
    format = saveFormat, width = width, height = height, units = units)
  SaveFigure(figFolder, "Female-2016_proportion", allPlots[[2]],
    format = saveFormat, width = width, height = height, units = units)
