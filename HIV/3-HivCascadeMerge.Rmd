...
analysisYear <- 2024
projectName <-  "ASR_2025" # "ASR_2024"; "HIV_Cascade_Paper"
...
if (multipleCascades && projectName == "ASR_2025") {
  cascadeNames <- c("All", "Male", "Female", "MSM_AUS", "MSM_OS", 
    "Hetero_ Aus", "Hetero_Os")
    # "MSM", "Indigenous", "AusNonIndigenous", 
    # "NonIndigenous", "Hetero", "Pwid", "SSA", "SEA", 
    # "SCA")
} else {
