...
analysisYear <- 2019
projectName <-  "Undiagnosed_Metrics_Paper" # "ASR_2022"; "HIV_Cascade_Paper"

multipleCascades <- TRUE
artNames <- NULL

# If this is an ASR project already have specific populations
if (multipleCascades && projectName == "ASR_2022") {
  ...
  cascadeNames <- "MSM-Aus" # specify cascades with project 
}
