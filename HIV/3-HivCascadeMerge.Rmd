...
if (projectName %in% c("ASR_2016", "ASR_2017", "ASR_2018")) {
  ...
  cascadeNames <- c("All", "Male", "Female", "Atsi", "AusNonAtsi", "MSM", 
    "Hetero", "PWID", "Otherexp","SSA", "SEA", "Othercob")
}
...
mergeAll <- TRUE
saveResults <- TRUE
artString <- "NAPWHA" # "ATRAS", "PBS" - use NAPWHA for ASR_2017 and ATRAS
                      # for Paper_2016
