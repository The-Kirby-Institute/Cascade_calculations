...
# TODO: do a better job cleaning AHOD so that ahodPop aligns with linkage 
ahodState <- "all" # Default as most states do not have there own data. 
ahodPop <- "all"   # Used when artname is different to AHOD name
                   
linkagePop <- "all" # to pick the right name corresponding to the cascade name
