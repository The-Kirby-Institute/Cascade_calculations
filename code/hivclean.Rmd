...
hivdata$linked <- NA
# hivdata[is.na(hivdata$cd4count) & hivdata$yeardiagnosis < 2014,] <- "no"
# hivdata[!is.na(hivdata$cd4count) & hivdata$yeardiagnosis < 2014,] <- "yes"

# hivdata[hivdata$yeardiagnosis >= 2014,] <- 
# If datecd4 - datediagnosis < 30 <- "yes"
# If datecd4 - datediagnosis < 30 <- "no"
