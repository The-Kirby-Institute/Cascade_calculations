...
if (dataYear <= 2013) {
  ...
  hivdata[hivdata$yearhiv >= 2014 & !is.na(hivdata$cd4date - hivdata$datediagnosis) & 
            (hivdata$cd4date - hivdata$datediagnosis) <= 90,]$linked <- "yes"
  hivdata[hivdata$yearhiv >= 2014 & !is.na(hivdata$cd4date - hivdata$datediagnosis) &
            (hivdata$cd4date - hivdata$datediagnosis) > 90,]$linked <- "no"
...
pharmData <- read.csv(rawPharmDash,skip = 16,na.strings = c("NA", ""))
