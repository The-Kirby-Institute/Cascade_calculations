...
notificationsFile <- file.path(basePath, "data",
...
maleRetested <- filter(chlamcascade, stage == "notifications",
  sex == "male")$estimate * c(propReTest, propReTestMin, propReTestMax)

femaleRetested <- filter(chlamcascade, stage == "notifications",
  sex == "female")$estimate * c(propReTest, propReTestMin, propReTestMax)
