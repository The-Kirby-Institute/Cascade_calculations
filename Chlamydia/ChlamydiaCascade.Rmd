...
if (paper) {
  ...
  notificationsFile <- file.path(dataFolder,
    paste("chlamnotifications_clean-", toString(tail(resultsYear, 1)),
      ".csv", sep = ""))
} 
...
if (saveCascade) {
  ...
  if (paper) {
    dir.create(file.path(basePath, "output", paste0(toString(resultsYear),
      "-paper")), showWarnings = FALSE)
    resultsFolder <- file.path(basePath, "output",
      paste0(toString(resultsYear), "-paper"))
  } else {
...
stages <- c("infections" = "New infections", 
  ...
  "retested" = "Re-testing following diagnosis")
