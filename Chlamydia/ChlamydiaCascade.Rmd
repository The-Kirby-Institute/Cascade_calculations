...
# Script parameters
resultsYear <- 2015 # year of cascade we will calculate and plot     
saveCascade <- FALSE                    
...
if (resultsYear == 2015) {
  ...
  femaleVicProp <- c(0.23732887, 0.236128214, 0.228577183, 0.242843632,
                     ...
                     0.250829686)
  allVicProp <- c(0.264047108, 0.252757725, 0.243711463, 0.261540898,
                  0.251955083, 0.265072308,	0.278668533,	0.274679677,
                  0.276308761)
