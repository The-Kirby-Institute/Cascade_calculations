...
# Script parameters
resultsYear <- 2020 # year of cascade we will calculate and plot   
dataYear <- 2020 # year data for estimates was generated (to handle updated 
...
plotcascade <- filter(chlamcascade, year == 2020)
