...
# Overall
replaceValues <- FALSE # Replace with specific estimates
...
for (pop in populations) {
  ...
  # Number treated 
  treatDf <- filter(hivTreated, population == pop, year >= dataStart)
...
# Load hard coded estimates
  ...
  # Replace with updated values
  for (ii in 1:nrow(hardCodeValues)) {
    hivCascade <- hivCascade %>%
      mutate(value = ifelse(population == hardCodeValues$population[ii] &
                            year == hardCodeValues$year[ii] &
                            stage == hardCodeValues$stage[ii], 
                            hardCodeValues$value[ii],
                            value),
             lower = ifelse(population == hardCodeValues$population[ii] &
                            year == hardCodeValues$year[ii] &
                            stage == hardCodeValues$stage[ii], 
                            hardCodeValues$lower[ii],
                            lower),
             upper = ifelse(population == hardCodeValues$population[ii] &
                            year == hardCodeValues$year[ii] &
                            stage == hardCodeValues$stage[ii], 
                            hardCodeValues$upper[ii],
                            upper))
  }
}
