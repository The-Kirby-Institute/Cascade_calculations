...
if (permDeparts) {
  ...
  # WARNING: where migration rates experimented on
...
# First do a quick calculation to work out proportion of  all
# notifications which are indigenous to adjust mortality and migration
# rates. 
...
nonAborigMortality <- deathRate * ((1-aborigMortality) *
                      fillAborigDiags$value + 
                      nonAborigDiags) / nonAborigDiags

nonAborigMigration <- migrationRate * cumDiagnoses / nonAborigDiags
...
for (pop in pops) {
  ...
  # If non-Indigenous then no need to adjust death rate to account 
  # for higher indigenous rate. Use notifications proportion for 
  # calculation. 
