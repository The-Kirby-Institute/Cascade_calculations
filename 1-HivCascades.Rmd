...
for (region in statesDiag) {
  ...
  pldhivStateMax <- LivingDiagnosed(propStayUpper * cumStateDiags,
                                    ...
                                    arrStateRate,epStateRate, pldhivAll)                                   
...
for (pop in pops) {
  ...
  if (pop == "indigenous") {
    ...
    pldhivPop <- LivingDiagnosed(nonAborigMigrationFactor * 
                                   propStay * cumPopDiags, 
                                 nonAborigMortalityFactor * deathRate,
                                 nonAborigMigrationFactor * migrationRate)
    
    pldhivPopMin <- LivingDiagnosed(nonAborigMigrationFactor * 
                                      propStayLower * cumPopDiags, 
                                    nonAborigMortalityFactor * 
                                      deathRateMax,
                                    nonAborigMigrationFactor * 
                                      migrationRateMax)
    
    pldhivPopMax <- LivingDiagnosed(nonAborigMigrationFactor *
                                      propStayUpper * cumPopDiags, 
                                    nonAborigMortalityFactor * 
                                      deathRateMin,
                                    nonAborigMigrationFactor *
                                      migrationRateMin)
