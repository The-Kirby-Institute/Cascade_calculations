...
# Plot specs
stages <- c("infected", "pldhiv", "linked", "numART", "suppressed")
stageNames <- c("Living with HIV", "Diagnosed", "Linked to care", 
                "Receiving ART", "Suppressed virus")
...
levels(resultsAll$stage) <- c("Living with HIV", "Linked to care", 
                              ...
                              "Suppressed virus")
resultsAll <- within(resultsAll, stage <- factor(stage, levels(stage)[c(1, 4, 2, 3, 5)]))
