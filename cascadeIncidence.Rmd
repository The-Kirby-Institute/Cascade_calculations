...
basePath <- file.path("~", "Research", "!Evaluation_Modelling", "project_care_cascades")
setwd(basePath)

# Various directories
dataFolder <- file.path(basePath, "data", "countData")
...
fullRun <- FALSE # Everytime we do a run from scratch save everything 
...
countData <- read_excel(file.path(dataFolder, inputFile), na = "NA")
